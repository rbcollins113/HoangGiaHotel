...
class FacilitiesControllerTest < ActionController::TestCase
  ...
  test "should create facility" do
    assert_difference('Facility.count') do
      post :create, facility: { description: @facility.description, shot_title: @facility.shot_title, title: @facility.title }
    end
  ...
  test "should update facility" do
    patch :update, id: @facility, facility: { description: @facility.description, shot_title: @facility.shot_title, title: @facility.title }
    assert_redirected_to facility_path(assigns(:facility))
  end
